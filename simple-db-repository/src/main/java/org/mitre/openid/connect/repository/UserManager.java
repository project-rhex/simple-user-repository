...
/**
 * The user manager performs all internal tasks related to CRUD operations, and
 * managing users.
 * 
 * @author DRAND
 * 
...
public interface UserManager {
     ...
     * 
     * @param likePattern
     *            a pattern to pass to the like clause
     ...
     * 
     * @param first
     *            initial offset into the user collection given the sorting
     * @param count
